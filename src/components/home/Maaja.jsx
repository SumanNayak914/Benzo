...
const Maaja = () => {
  ...
  const products = [
    { id: 1, name: "Maaza Mango Drink", qty: "600 ml", price: 45, image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSBqOWlp10TSHByQjInIlh05hgNTfGfAb-6Yg&s" },
    { id: 2, name: "Frooti Mango Drink", qty: "1 L", price: 60, image: "https://m.media-amazon.com/images/I/51TNaTSPSJL._UF1000,1000_QL80_.jpg" },
    { id: 3, name: "Appy Fizz", qty: "750 ml", price: 55, image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQvzpqkwZUrYQvRdAt5xmgs-36aK8z5L4F_H4tknHgGhoF1Gz_IHiW4l-w&s=10" },
    { id: 4, name: "Pepsi", qty: "750 ml", price: 40, image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTlarOhHAAC0zvAngSEp3cQJNvowkNSyiQO60yX5iz4_4QBJL7U9SCORsE&s=10" },
    { id: 5, name: "Coca Cola", qty: "750 ml", price: 40, image: "https://cdn.grofers.com/da/cms-assets/cms/product/6646686b-a7eb-40e9-8e2a-808397ec155c.jpg" },
    { id: 6, name: "Thumbs Up", qty: "750 ml", price: 40, image: "https://www.bbassets.com/media/uploads/p/xl/251014_12-thums-up-soft-drink.jpg" },
    { id: 7, name: "Sprite", qty: "750 ml", price: 40, image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSgO3UIszzPlkmz4MRk3M7V8wgsqfH4MJyjzQBtGn7s7Z2_RXu83-XKL0Ia&s=10" },
    { id: 8, name: "Slice Mango Drink", qty: "600 ml", price: 45, image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRb0esZ3wTLDK1752MvSRqkqvmpPyvKPJek_h92YzRJ43MueVLELVERtj7u&s=10" },
    { id: 9, name: "Real Fruit Juice - Orange", qty: "1 L", price: 120, image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTIuXZHl4ZVZ3G14phviRMhu9JO8pwWLwXYEL11c8xnEPbIsOqoFjAEqbY&s=10" },
    { id: 10, name: "Real Fruit Juice - Mixed Fruit", qty: "1 L", price: 120, image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQfU6gIAn8QzjTop-mwUGGm5R5e6xKBm2COde16e_C3tQBY1ekURuiYjjDd&s=10" },
  ];
  ...
  return (
    <div className="bg-gradient-to-b from-pink-50 to-white py-6 px-4">
      <div className="max-w-7xl mx-auto">
        {/* Heading */}
        <h2 className="text-2xl md:text-3xl font-bold text-pink-600 mb-6">Maaja Specials</h2>
        ...
        <div className="block md:hidden">
          <div className="grid grid-cols-3 gap-3 mb-4">
            {visibleProducts.map((item) => (
              <div
                key={item.id}
                className="bg-white rounded-lg overflow-hidden relative p-2 flex flex-col"
              >
                ...
                <div className="w-full mt-1 text-left">
                  ...
                  <p className="text-[11px] text-gray-500">{item.qty}</p>
                  <div className="text-sm font-bold text-green-600">₹{item.price}</div>
                </div>

                <button
                  onClick={() => handleAddClick(item.id)}
                  className={`mt-2 px-2 py-1 self-start rounded-full text-xs font-semibold ${
                    addedItems[item.id] ? "bg-green-500 text-white" : "bg-pink-500 text-white"
                  }`}
                >
                  {addedItems[item.id] ? "Added" : "Add"}
                </button>
          ...
          {products.length > 6 && (
            <div className="text-center">
              <button
                onClick={() => setShowAll(!showAll)}
                className="bg-pink-600 text-white px-5 py-2 rounded-full text-sm"
              >
        ...
        <div className="hidden md:block">
          <div className="flex gap-6 overflow-x-auto no-scrollbar pb-4">
            {products.map((item) => (
              <div
                key={item.id}
                className="min-w-[160px] max-w-[180px] bg-white rounded-2xl shadow-md relative flex-shrink-0 p-3 flex flex-col"
              >
                ...
                <div className="mt-2 text-left">
                  ...
                  <span className="text-base font-bold text-green-600 mt-1 block">₹{item.price}</span>
                </div>
                <button
                  onClick={() => handleAddClick(item.id)}
                  className={`mt-2 px-3 py-1 self-start rounded-full text-xs font-bold ${
                    addedItems[item.id] ? "bg-green-500 text-white" : "bg-pink-500 text-white"
                  }`}
                >
                  {addedItems[item.id] ? "Added" : "Add"}
