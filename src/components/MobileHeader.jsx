...
// import { Search, ChevronDown, MapPin, ShoppingCart, User } from 'lucide-react';
...
//           {/* Benzo Buttons - Centered and Wider */}
...
//               <span className={`text-sm font-medium ${currentMobileCategory?.textColor || 'text-blue-800'}`}>Delivery Location</span>
...
//             >
//               <User className={`w-5 h-5 ${currentMobileCategory?.textColor || 'text-blue-800'}`} />
//             </button>
//           </div>
//         </div>
//       </div>
...
//         className="md:hidden fixed bottom-6 right-6 bg-blue-600 text-white p-4 rounded-full shadow-lg hover:bg-blue-700 transition-colors z-30"
//       >
...
import React, { useState, useRef } from 'react';
import { Search, ChevronDown, MapPin, ShoppingCart, User, X } from 'lucide-react';
import { motion, AnimatePresence } from "framer-motion";
